...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var slideClassNames = ['.slide-1', '.slide-2', '.slide-3', '.slide-4'];
    slideClassNames.forEach(function (slide, ind) {
        ScrollAnimation.scrollHandler({
            scrollingElementSelector: "".concat(slide, " .left"),
            animatedElementSelector: "".concat(slide, " .highlight"),
            boundaryStart: 'bottom',
            boundaryEnd: 'top',
